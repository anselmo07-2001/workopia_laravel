<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
            ...
            >
                ...
                <x-inputs.text type="number" id="salary" name="salary" 
                            label="Annual Salary" placeholder="90000" :value="old('salary', $job->salary)" />
                ...
                <x-inputs.text id="city" name="city" label="City" placeholder="City" :value="old('city', $job->city)"/>
                ...
                <x-inputs.text id="company_website" name="company_website" :value="old('company_website', $job->company_website)" 
                ...
                <x-inputs.text type="email" id="contact_email" name="contact_email" :value="old('contact_email', $job->contact_email)"
                        label="Contact Email" placeholder="Email where you want to receive applications"/>

                <x-inputs.file id="company_logo" name="company_logo"/>

                <button
                    type="submit"
                    class="w-full bg-green-500 hover:bg-green-600 text-white px-4 py-2 my-3 rounded focus:outline-none focus:ring-1 focus:ring-gray-400"
                >
                    Save
                </button>
            </form>
